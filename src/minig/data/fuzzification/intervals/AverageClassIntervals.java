 ...
 * @author jrabc
 */
public class AverageClassIntervals implements IntervalFinder {

    private NumericAttr input;
    private FuzzyAttr output;

    public AverageClassIntervals(NumericAttr input, FuzzyAttr output) {
        this.input = input;
        this.output = output;
    }
    ...
    public AverageClassIntervals(Attribute output) {
    ...
    public static void main(String[] args) {
        ...
        IntervalFinder iv = new AverageClassIntervals((NumericAttr) dt.getAttribute(2), (FuzzyAttr) dt.getOutbputAttribute());
